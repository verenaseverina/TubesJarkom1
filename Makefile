...
bin/receiver.o: src/receiver.cpp src/receiver_window.h src/receiver_socket.h src/file.h
...
bin/sender.o: src/sender.cpp src/sender_window.h src/sender_socket.h src/file.h
